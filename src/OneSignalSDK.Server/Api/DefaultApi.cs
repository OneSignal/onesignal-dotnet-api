...
namespace OneSignalSDK.Server.Api
{
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        {
            OneSignalSDK.Server.Client.ApiResponse<InlineResponse2005> localVarResponse = CreatePlayerWithHttpInfo(player);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InlineResponse2005</returns>
        public OneSignalSDK.Server.Client.ApiResponse<InlineResponse2005> CreatePlayerWithHttpInfo(Player player, int operationIndex = 0)
        {
        ...
        {
            OneSignalSDK.Server.Client.ApiResponse<InlineResponse2005> localVarResponse = await CreatePlayerWithHttpInfoAsync(player, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2005)</returns>
        public async System.Threading.Tasks.Task<OneSignalSDK.Server.Client.ApiResponse<InlineResponse2005>> CreatePlayerWithHttpInfoAsync(Player player, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'player' is set
            if (player == null)
            {
        ...
        {
            OneSignalSDK.Server.Client.ApiResponse<InlineResponse2007> localVarResponse = DeletePlayerWithHttpInfo(appId, playerId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InlineResponse2007</returns>
        public OneSignalSDK.Server.Client.ApiResponse<InlineResponse2007> DeletePlayerWithHttpInfo(string appId, string playerId, int operationIndex = 0)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
            {
        ...
        {
            OneSignalSDK.Server.Client.ApiResponse<InlineResponse2007> localVarResponse = await DeletePlayerWithHttpInfoAsync(appId, playerId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2007)</returns>
        public async System.Threading.Tasks.Task<OneSignalSDK.Server.Client.ApiResponse<InlineResponse2007>> DeletePlayerWithHttpInfoAsync(string appId, string playerId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
            {
        ...
        {
            OneSignalSDK.Server.Client.ApiResponse<InlineResponse2008> localVarResponse = ExportPlayersWithHttpInfo(appId, exportPlayersRequestBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InlineResponse2008</returns>
        public OneSignalSDK.Server.Client.ApiResponse<InlineResponse2008> ExportPlayersWithHttpInfo(string appId, ExportPlayersRequestBody exportPlayersRequestBody = default(ExportPlayersRequestBody), int operationIndex = 0)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
            {
        ...
        {
            OneSignalSDK.Server.Client.ApiResponse<InlineResponse2008> localVarResponse = await ExportPlayersWithHttpInfoAsync(appId, exportPlayersRequestBody, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2008)</returns>
        public async System.Threading.Tasks.Task<OneSignalSDK.Server.Client.ApiResponse<InlineResponse2008>> ExportPlayersWithHttpInfoAsync(string appId, ExportPlayersRequestBody exportPlayersRequestBody = default(ExportPlayersRequestBody), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
            {
