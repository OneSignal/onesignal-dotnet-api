...
namespace OneSignalSDK.Server.Model
{
    ...
    public partial class Notification : IEquatable<Notification>, IValidatableObject
    {
        ...
        /// <param name="sendAfter">sendAfter.</param>
        ...
        /// <param name="emailSubect">Channel: Email Required.  The subject of the email. .</param>
        ...
        /// <summary>
        /// Gets or Sets SendAfter
        /// </summary>
        [DataMember(Name = "send_after", EmitDefaultValue = false)]
        public DateTimeOrLong SendAfter { get; set; }
        ...
        /// </summary>
        /// <value>Channel: All Apps with throttling enabled:   - the parameter value will be used to override the default application throttling value set from the dashboard settings.   - parameter value 0 indicates not to apply throttling to the notification.   - if the parameter is not passed then the default app throttling value will be applied to the notification. Apps with throttling disabled:   - this parameter can be used to throttle delivery for the notification even though throttling is not enabled at the application level. Refer to throttling for more details. </value>
        [DataMember(Name = "throttle_rate_per_minute", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "email_subect", EmitDefaultValue = false)]
        public string EmailSubect { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmailSubect: ").Append(EmailSubect).Append("\n");
        ...
        public bool Equals(Notification input)
        {
            ...
            return 
                ...
                (
                    this.EmailSubect == input.EmailSubect ||
                    (this.EmailSubect != null &&
                    this.EmailSubect.Equals(input.EmailSubect))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmailSubect != null)
                {
                    hashCode = (hashCode * 59) + this.EmailSubect.GetHashCode();
                }
