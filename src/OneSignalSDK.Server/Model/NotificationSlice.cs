...
namespace OneSignalSDK.Server.Model
{
    ...
    public partial class NotificationSlice : IEquatable<NotificationSlice>, IValidatableObject
    {
        ...
        public NotificationSlice(int totalCount = default(int), int offset = default(int), int limit = default(int), List<Notification> notifications = default(List<Notification>))
        {
