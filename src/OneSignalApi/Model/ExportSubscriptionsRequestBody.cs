...
namespace OneSignalApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "export_subscriptions_request_body")]
    public partial class ExportSubscriptionsRequestBody : IEquatable<ExportSubscriptionsRequestBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportSubscriptionsRequestBody" /> class.
        /// </summary>
        ...
        public ExportSubscriptionsRequestBody(List<string> extraFields = default(List<string>), string lastActiveSince = default(string), string segmentName = default(string))
        {
        ...
        {
            return this.Equals(input as ExportSubscriptionsRequestBody);
        }

        /// <summary>
        /// Returns true if ExportSubscriptionsRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportSubscriptionsRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportSubscriptionsRequestBody input)
        {
            if (input == null)
            {
                return false;
