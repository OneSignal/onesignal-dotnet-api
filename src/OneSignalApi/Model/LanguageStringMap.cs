...
namespace OneSignalApi.Model
{
    ...
    /// LanguageStringMap
    /// </summary>
    [DataContract(Name = "LanguageStringMap")]
    public partial class LanguageStringMap : IEquatable<LanguageStringMap>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageStringMap" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as LanguageStringMap);
        }

        /// <summary>
        /// Returns true if LanguageStringMap instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageStringMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageStringMap input)
        {
            if (input == null)
            {
                return false;
