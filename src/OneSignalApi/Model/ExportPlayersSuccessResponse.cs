...
namespace OneSignalApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExportPlayersSuccessResponse")]
    public partial class ExportPlayersSuccessResponse : IEquatable<ExportPlayersSuccessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportPlayersSuccessResponse" /> class.
        /// </summary>
        /// <param name="csvFileUrl">csvFileUrl.</param>
        public ExportPlayersSuccessResponse(string csvFileUrl = default(string))
        {
        ...
        {
            return this.Equals(input as ExportPlayersSuccessResponse);
        }

        /// <summary>
        /// Returns true if ExportPlayersSuccessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportPlayersSuccessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportPlayersSuccessResponse input)
        {
            if (input == null)
            {
                return false;
