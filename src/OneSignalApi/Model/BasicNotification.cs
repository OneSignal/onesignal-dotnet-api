...
namespace OneSignalApi.Model
{
    ...
    public partial class BasicNotification : IEquatable<BasicNotification>, IValidatableObject
    {
        ...
        /// <param name="globalImage">Channel: Push Notifications Platform: All Picture to display on all platforms that support it. Must be a URL to an image file. Platform-specific picture fields (big_picture, huawei_big_picture, adm_big_picture, chrome_web_image, ios_attachments, firefox_icon) take precedence over this value when set. .</param>
        ...
        /// <param name="emailBcc">Channel: Email BCC recipients for the email. Maximum 5 addresses. Only supported when the email service provider is OneSignal Email. .</param>
        ...
        /// </summary>
        /// <value>This field does **not** target users by their External ID. To send to External IDs, use &#x60;include_aliases&#x60; with the label &#x60;external_id&#x60; plus &#x60;target_channel&#x60; as documented for alias-based targeting.  [DEPRECATED] Correlation and idempotency key. A request received with this parameter will first look for another notification with the same external_id. If one exists, a notification will not be sent, and result of the previous operation will instead be returned. Therefore, if you plan on using this feature, it&#39;s important to use a good source of randomness to generate the UUID passed here. This key is only idempotent for 30 days. After 30 days, the notification could be removed from our system and a notification with the same external_id will be sent again.   See Idempotent Notification Requests for more details writeOnly: true </value>
        ...
        /// </summary>
        /// <value>Channel: Push Notifications Platform: All Picture to display on all platforms that support it. Must be a URL to an image file. Platform-specific picture fields (big_picture, huawei_big_picture, adm_big_picture, chrome_web_image, ios_attachments, firefox_icon) take precedence over this value when set. </value>
        [DataMember(Name = "global_image", EmitDefaultValue = true)]
        ...
        public List<WebButton> WebButtons { get; set; }
        ...
        /// </summary>
        /// <value>Channel: Push Notifications Platform: iOS 15+ A score to be set per notification to indicate how it should be displayed when grouped. Use a float between 0-1. </value>
        ...
        /// </summary>
        /// <value>Channel: Push Notifications Platform: iOS 15+ Focus Modes and Interruption Levels indicate the priority and delivery timing of a notification, to \&quot;interrupt\&quot; the user. Can choose from options: [&#39;active&#39;, &#39;passive&#39;, &#39;time_sensitive&#39;, &#39;critical&#39;]. Default is active. </value>
        ...
        /// </summary>
        /// <value>Channel: Email Default is &#x60;false&#x60;. If set to &#x60;true&#x60;, the URLs sent within the email will not include link tracking and will be the same as originally set; otherwise, all the URLs in the email will be tracked.</value>
        [DataMember(Name = "disable_email_click_tracking", EmitDefaultValue = true)]
        public bool? DisableEmailClickTracking { get; set; }
        ...
        /// </summary>
        /// <value>Channel: Email BCC recipients for the email. Maximum 5 addresses. Only supported when the email service provider is OneSignal Email. </value>
        ...
        /// </summary>
        [DataMember(Name = "email_warm_up", EmitDefaultValue = true)]
        public EmailWarmUpRequest EmailWarmUp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GlobalImage: ").Append(GlobalImage).Append("\n");
            ...
            sb.Append("  IosInterruptionLevel: ").Append(IosInterruptionLevel).Append("\n");
        ...
        public bool Equals(BasicNotification input)
        {
            ...
            return 
                ...
                (
                    this.GlobalImage == input.GlobalImage ||
                    (this.GlobalImage != null &&
                    this.GlobalImage.Equals(input.GlobalImage))
                ) && 
                (
                ...
                (
                    this.IosInterruptionLevel == input.IosInterruptionLevel ||
                    (this.IosInterruptionLevel != null &&
                    this.IosInterruptionLevel.Equals(input.IosInterruptionLevel))
                ) && 
                (
                ...
                (
                    this.DisableEmailClickTracking == input.DisableEmailClickTracking ||
                    (this.DisableEmailClickTracking != null &&
                    this.DisableEmailClickTracking.Equals(input.DisableEmailClickTracking))
                ) && 
                (
                    this.IncludeUnsubscribed == input.IncludeUnsubscribed ||
                    (this.IncludeUnsubscribed != null &&
                ...
                (
                    this.EmailSenderDomain == input.EmailSenderDomain ||
                    (this.EmailSenderDomain != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.GlobalImage.GetHashCode();
                }
                ...
                if (this.IosInterruptionLevel != null)
                {
                    hashCode = (hashCode * 59) + this.IosInterruptionLevel.GetHashCode();
                }
                ...
                if (this.DisableEmailClickTracking != null)
                {
                    hashCode = (hashCode * 59) + this.DisableEmailClickTracking.GetHashCode();
                }
                if (this.IncludeUnsubscribed != null)
                {
