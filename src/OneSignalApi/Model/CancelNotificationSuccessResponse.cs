...
namespace OneSignalApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CancelNotificationSuccessResponse")]
    public partial class CancelNotificationSuccessResponse : IEquatable<CancelNotificationSuccessResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">Instance of CancelNotificationSuccessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelNotificationSuccessResponse input)
        {
            if (input == null)
            {
                return false;
