...
namespace OneSignalApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserIdentityResponse")]
    public partial class UserIdentityResponse : IEquatable<UserIdentityResponse>, IValidatableObject
    {
        ...
        public UserIdentityResponse(Dictionary<string, Object> identity = default(Dictionary<string, Object>))
        {
        ...
        {
            return this.Equals(input as UserIdentityResponse);
        }

        /// <summary>
        /// Returns true if UserIdentityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UserIdentityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserIdentityResponse input)
        {
            if (input == null)
            {
                return false;
