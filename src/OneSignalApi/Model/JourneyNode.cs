...
namespace OneSignalApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JourneyNode")]
    public partial class JourneyNode : IEquatable<JourneyNode>, IValidatableObject
    {
        /// <summary>
        /// Node kind. Selects which other fields apply.
        /// </summary>
        /// <value>Node kind. Selects which other fields apply.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JourneyNode" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Server-assigned node UUID. Returned on reads. Required on update to keep an existing node. Rejected on create with a 400 validation error.</value>
        ...
        {
            return this.Equals(input as JourneyNode);
        }

        /// <summary>
        /// Returns true if JourneyNode instances are equal
        /// </summary>
        /// <param name="input">Instance of JourneyNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JourneyNode input)
        {
            if (input == null)
            {
                return false;
